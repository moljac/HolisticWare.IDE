...
public partial class TemplateConditions {
    ...
    private TemplateConditionsPartialTypeSupport[] partialTypeSupportField;
    
    private TemplateConditionsMacProject[] macProjectField;
    
    /// <remarks/>
    [System.Xml.Serialization.XmlElementAttribute("PartialTypeSupport", Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
    public TemplateConditionsPartialTypeSupport[] PartialTypeSupport {
        get {
            return this.partialTypeSupportField;
        }
        set {
            this.partialTypeSupportField = value;
        }
    }
